...
import { JtThemePicker } from './theme-picker';
...
describe('JtThemePicker', () => {
    let component: JtThemePicker;
    let fixture: ComponentFixture<JtThemePicker>;
    ...
    beforeEach(async () => {
      ...
      mockCurrentTheme$.next(initialThemeState);
        ...
        fixture = TestBed.createComponent(JtThemePicker);
