...
import { JtDarkModeToggle } from './dark-mode-toggle';
...
describe('JtDarkModeToggle', () => {
  let component: JtDarkModeToggle;
  let fixture: ComponentFixture<JtDarkModeToggle>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(JtDarkModeToggle);
