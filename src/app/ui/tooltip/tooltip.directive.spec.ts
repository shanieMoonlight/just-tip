...
import { JtUiTooltipDirective } from './tooltip.directive';

@Component({
  template: `<button jtTooltip="Test tooltip" tooltipPosition="top">Hover me</button>`,
  standalone: true,
  imports: [JtUiTooltipDirective],
})
...
describe('SbTooltipDirective', () => {
  ...
  it('should create an instance', () => {
    const tooltipDe = fixture.debugElement.query(By.directive(JtUiTooltipDirective));
    expect(tooltipDe).toBeTruthy();
    expect(tooltipDe.injector.get(JtUiTooltipDirective)).toBeTruthy();
  });
