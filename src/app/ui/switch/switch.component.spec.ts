...
import { JtSwitchComponent } from './switch.component';

describe('JtSwitchComponent', () => {
  let fixture: ComponentFixture<JtSwitchComponent>;
  let component: JtSwitchComponent;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [JtSwitchComponent],
    }).compileComponents();

    fixture = TestBed.createComponent(JtSwitchComponent);
